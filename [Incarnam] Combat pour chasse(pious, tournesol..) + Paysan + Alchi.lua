...
FORBIDDEN_MONSTERS = {
    --979, --Pissenlit Miroitant
    --980, --Rose Vaporeuse
    --981, --Tournesol Nébuleux
    --970, --Tofu Chimérique
    --971, --Bouftou Nuageux
    --972, --Boufton Pâlichon
    --973, --Boufton Orageux
    --984, --Bouftor Éthéré
...
function move()
    ...
    return {
        ...
        { map = "4,-4", gather = true, fight = true, changeMap = "left" }, 
        { map = "4,-3", gather = true, fight = true, changeMap = "left" }, 
        { map = "3,-3", gather = true, fight = true, changeMap = "top" }, 
        { map = "3,-4", gather = true, fight = true, changeMap = "top" }, 
        { map = "3,-5", gather = true, fight = true, changeMap = "left" }, 
        { map = "2,-5", gather = true, fight = true, changeMap = "left" }, 
        { map = "1,-5", gather = true, fight = true, changeMap = "left" }, 
        { map = "0,-5", gather = true, fight = true, changeMap = "left" }, 
        { map = "-1,-5", gather = true, fight = true, changeMap = "top" }, 
        { map = "-1,-6", gather = true, fight = true, changeMap = "left" }, 
        { map = "-2,-6", gather = true, fight = true, changeMap = "left" }, 
        { map = "-3,-6", gather = true, fight = true, changeMap = "bottom" }, 
        { map = "-3,-5", gather = true, fight = true, changeMap = "right" }, 
        { map = "-2,-5", gather = true, fight = true, changeMap = "bottom" }, 
        { map = "-2,-4", gather = true, fight = true, changeMap = "right" }, 
        { map = "-1,-4", gather = true, fight = true, changeMap = "right" }, 
        { map = "0,-4", gather = true, fight = true, changeMap = "right" }, 
        { map = "1,-4", gather = true, fight = true, changeMap = "right" }, 
        { map = "2,-4", gather = true, fight = true, changeMap = "right" }, 
